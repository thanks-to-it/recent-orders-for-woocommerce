...
class Alg_WC_Recent_Orders_Settings_General extends Alg_WC_Recent_Orders_Settings_Section {
	 ...
	 * @todo    (desc) `order_statuses` (Pro only)?
	 */
	function get_settings() {
		return array(
			...
			array(
				...
				'desc'              =>
					sprintf(
						__( 'Recent orders can be outputted with the %s widget, or with the %s shortcode.', 'recent-orders-widget-for-woocommerce' ),
			...
			array(
				...
				'desc_tip'          =>
					...
					__( 'You can use shortcodes here.', 'recent-orders-widget-for-woocommerce' ),
				'desc'              =>
					$this->get_placeholders_text( array(
						'%product_id%',
						'%product_url%',
						'%product_title%',
